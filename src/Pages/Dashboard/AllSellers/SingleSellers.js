...
const SingleSellers = ({dt, handleDelete, handleVerify}) => {
    return (
        <tr>
            ...
            <td className="p-2 whitespace-nowrap">
                {dt?.verified ? <p>Verified</p> : <button onClick={() => handleVerify(dt?._id)} className='btn'>Verify</button>}
            </td>
            <td className="p-2 whitespace-nowrap">
